...
def run_test_even_better_draw_circles():
    ...
    print('-------------------------------------------------------')
    even_better_draw_circles(8, 'purple', rg.Point(200, 200))
    even_better_draw_circles(5, 'blue', rg.Point(100, 100))
    even_better_draw_circles(4, 'pink', rg.Point(300, 300))


def even_better_draw_circles(n, j, m):
